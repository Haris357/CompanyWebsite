        ...
        <div className="flex flex-wrap justify-center items-center gap-4 sm:gap-6 md:gap-8 px-4">
          {data.members?.map((member, index) => (
            ...
            >
              ...
              >
                {/* Avatar Image */}
                <div className="relative w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-full overflow-hidden ring-2 sm:ring-4 ring-white/10 group-hover:ring-white/30 transition-all">
                  <Image
                ...
                <motion.div
                  ...
                  className="absolute top-full left-1/2 transform -translate-x-1/2 mt-3 sm:mt-4 pointer-events-none opacity-0 group-hover:opacity-100 transition-all duration-300 z-20"
                >
                  <div className="glass-dark p-3 sm:p-4 rounded-xl sm:rounded-2xl min-w-[180px] sm:min-w-[200px] text-center">
                    <h3 className="text-white font-bold text-sm sm:text-base md:text-lg mb-1">
                      {member.name}
                    </h3>
                    <p className="text-xs sm:text-sm font-semibold mb-2" style={{ color: 'var(--primary-color)' }}>
                      {member.position}
                    </p>
                    {member.bio && (
                      ...
                      <div className="flex items-center justify-center gap-1.5 sm:gap-2">
                        {member.socialMedia.linkedin && (
                          <a
                            ...
                            className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg glass flex items-center justify-center text-gray-400 hover:text-white transition-colors pointer-events-auto"
                          >
