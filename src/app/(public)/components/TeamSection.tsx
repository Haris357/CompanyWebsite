          ...
          {data.members?.map((member, index) => (
            ...
            >
              <div style={{
                ...
                {/* Info */}
                <div className="p-6">
                  <h3 style={{ color: 'var(--text-color)' }} className="text-xl font-bold mb-1">
                    {member.name}
                  </h3>
                  <p style={{ color: 'var(--primary-color)' }} className="font-medium mb-3 text-sm">
                    {member.position}
                  </p>
                  <p style={{ color: 'var(--text-color)', opacity: 0.7 }} className="text-sm mb-4 line-clamp-2">
                    {member.bio}
                  </p>
